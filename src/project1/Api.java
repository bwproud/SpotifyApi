...
public class Api {
  ...
  public CurrentUserTopRequest.Builder getTopTracks() {
	    final CurrentUserTopRequest.Builder builder = CurrentUserTopRequest.builder();
	    setDefaults(builder);
	    builder.path("/v1/me/top/tracks");
	    return builder;
	  }
